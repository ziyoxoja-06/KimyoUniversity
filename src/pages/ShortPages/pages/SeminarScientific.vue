...
<template>
  <div class="lab">
    <p class="title text-center text-h5 text-weight-bold">A list if the members of scientific seminar at scientific
      council awarding the scientific degrees</p>
    <p class="title__unique">Scientific Seminar at Scientific Council DSc.28.02.2018.T/FM.61.01 awarding the scientific
      degrees at the Institute of Mechanics and Seismic Stability of Structures and Tashkent Institute of Irrigation and
      Agricultural Mechanization Engineers</p>
    <p class="text-center" style="font-size: 20px">01.02.04 – MECHANICS OF DEFORMABLE RIGID BODY (IN PHYSICAL-MATHEMATICAL AND TECHNICAL SCIENCES)</p>
    <div class="q-pt-sm">
      <q-table
        :columns="columns"
        :filter="filter" :grid="screenSize.width < 1250"
