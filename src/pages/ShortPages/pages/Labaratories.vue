...
const columns = [
  ...
  {name: 'fat', label: 'Fat (g)', field: 'fat', align: 'left', sortable: true},
...
<template>
  <div class="lab">
    ...
    <div v-else>
      ...
      <p v-for="(item,i) in pagesList[layout.shortRout]?.description.split('\n')" :key="i" class="lab__description">
      ...
      <div class="user">
        ...
        <div class="user__content">
          <img :src="pagesList[layout.shortRout]?.teacher.img" alt="" class="user__img">
          <div class="user__info">
            <p class="">{{ pagesList[layout.shortRout]?.teacher.full_name }}</p>
            <p>{{ pagesList[layout.shortRout]?.teacher.degree }}</p>
            <p>{{ pagesList[layout.shortRout]?.teacher.number }}</p>
            <p>{{ pagesList[layout.shortRout]?.teacher.email }}</p>
          </div>
        </div>
      </div>
      <div class="table">
