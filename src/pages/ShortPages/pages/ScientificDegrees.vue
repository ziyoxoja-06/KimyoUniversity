...
<template>
  <div class="lab">
    <p class="title text-center text-h5 text-weight-bold">The list of the members of scientific council awarding the
      scientific degrees</p>
    <p class="title__unique">Scientific Council DSc.28.02.2018.T/FM.61.01 awarding the scientific degrees at the
      Institute of Mechanics and Seismic Stability of Structures and Tashkent Institute of Irrigation and Agricultural
      Mechanization Engineers</p>
    <div class="q-pt-sm">
      <q-table
        :columns="columns"
