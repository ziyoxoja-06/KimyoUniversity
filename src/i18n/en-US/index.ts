...
export default {
  ...
  subLayout: {
    ...
    labaratories_item: {
      one: "Laboratory of phosphorus fertilizers",
      two: "Nitrogen, complex fertilizers and simulants. Department of supermolecular brics",
      three: "Agrochemical laboratory",
      four: "Laboratory of metallurgical processes and man-made raw materials",
      five: "Laboratory of colloid chemistry and industrial ecology",
      six: "Petrochemical laboratory",
      seven: "Laboratory of silicate chemistry and chemical technology",
      eight: "Laboratory of defoliants",
      nine: '"STROM" Scientific Research Laboratory and Testing Center',
      ten: "Laboratory of chemical technology and equipment",
      eleven: "Chemical Technology, Gas Processing and SFM Laboratory",
    },
    ...
    scientific_grants:
      "Scientific grants carried out within the framework of the State Scientific-Technical Programs",
    ...
    scientific_degrees:
      "The list of the members of scientific council awarding the scientific degrees",
    scientific_seminar:
      "A list if the members of scientific seminar at scientific council awarding the scientific degrees",
